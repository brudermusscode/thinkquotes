...
$iterate_through_pages = 500;

if (!isset($_POST["getQuotes"]) || LOGGED || ADMIN) exit(json_encode($return));
...
$return->status = true;
$return->message = "Quotes downloaded for " . $iterate_through_pages . " pages!";
