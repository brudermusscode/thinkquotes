...
<div id="main" class="wpx--main">
  ...
  <create-grid class="mb32" data-load="content:quotes" data-json='[{"page":"profiles:drafts","limit":"20","uid":"<?php echo $user->uid; ?>"}]'>
