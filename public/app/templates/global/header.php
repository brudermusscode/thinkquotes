...
<header id="main-hdr" class="posrel">
  ...
  <div class="inr wpx--main posrel">
    <div class="middle-logo--outer posabs alignmiddle" style="z-index:100;">
      ...
      <hellofresh <?php if ($my->post_permissions == "none") { ?>disabled="true" <?php } ?>
        data-action="popup:quotes,add" class="hellofresh hover-shadow shadowed red rounded icon-only">
      ...
      <div class="lo-sizing">
        <div class="logo"
          style="background: transparent url(<?php echo IMAGE; ?>/global/newlogo.2.png) center no-repeat;background-size: cover;">
          <img src="<?php echo IMAGE . '/global/newlogo.2.png'; ?>" style="visibility:hidden;opacity:0;">
        </div>
      </div>
    ...
    <div class="rt-content">
      <div class="disfl fldirrow rt">
        ...
        <hellofresh data-action="popup:login" class="hellofresh rd6 big mr12 hover-shadow"
          style="color:var(--colour-light);">
          <div class="c-ripple js-ripple">
            <span class="c-ripple__circle"></span>
          </div>
          Log in
